 ...
 * if you need it. 
 *
 * I originally wrote this in May 1993, it has had minor tweaks
...
Lexicon::Lexicon(string filename) 
{
    edges = start = NULL;
    numEdges = numDawgWords = 0;
    //cout << "about to addWordsFromFile" << endl;
...
//    cout << "got headers" << endl;
    ...
    //cout << "about to test BYTE_ORDER" << endl;
#if defined(BYTE_ORDER) && BYTE_ORDER == LITTLE_ENDIAN
